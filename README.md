...
the bundled Xberg connector retains Markdown headings and subheadings for `mq`,
the original file, and Xberg's structured JSON. Packet decisions can durably
