  ...
  {"ok":true,"result":{"slug":"recovery-test","phase":"initialized","schema_version":23}}
...
Simulate a command whose process exited before recording its terminal event.
  ...
  {"ok":true,"result":{"slug":"recovery-test","resume_path":"workspaces/recovery-test/artifacts/resume/workspace.md","schema_version":23,"phase":"initialized","action":"start-reconnaissance","reason":"Workspace scope and plan are not yet defined.","advisory":true,"alternatives_possible":true},"next":"'sandwalk' 'recon' 'start' '--goal-file' 'goal.md' '--slug' 'recovery-test' '--directory-prefix' 'workspaces'"}
...
Recovery upgrades legacy state before generating guidance.
  ...
  {"ok":true,"result":{"slug":"legacy-recovery","resume_path":"legacy/legacy-recovery/artifacts/resume/workspace.md","schema_version":23,"phase":"researching","action":"claim-step","reason":"The selected dependency-ready plan step has no active claim.","advisory":true,"alternatives_possible":true,"step":"fixture-step"},"next":"'sandwalk' 'step' 'claim' '--step' 'fixture-step' '--slug' 'legacy-recovery' '--directory-prefix' 'legacy'"}
