  ...
  {"ok":true,"result":{"slug":"plan-test","phase":"initialized","schema_version":22}}
  ...
  {"ok":true,"result":{"slug":"plan-test","phase":"planning","schema_version":22}}
  ...
  $ sandwalk status --slug plan-test --directory-prefix workspaces
  {"ok":true,"result":{"slug":"plan-test","phase":"researching","schema_version":22}}
  ...
  {"ok":true,"result":{"slug":"plan-test","resume_path":"workspaces/plan-test/artifacts/resume/workspace.md","schema_version":22,"phase":"researching","action":"claim-step","reason":"The selected dependency-ready plan step has no active claim.","advisory":true,"alternatives_possible":true,"step":"primary-sources"},"next":"'sandwalk' 'step' 'claim' '--step' 'primary-sources' '--slug' 'plan-test' '--directory-prefix' 'workspaces'"}
